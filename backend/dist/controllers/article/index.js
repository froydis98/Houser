...
exports.deleteArticle = exports.updateArticle = exports.addArticle = exports.getArticleById = exports.getArticles = void 0;
...
const updateArticle = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const update = yield article_1.default.findByIdAndUpdate({ _id: id }, body);
        res.status(200).json({
